	...
	return (
		<PageLayout>
			<div className="py-6 pplicy flex flex-col gap-1">
				<h1>Terms Of Service (TOS) and Condition</h1>
				<p>
					...
					your use of the https://emanga.tk website and any of its
				...
				<p>
					...
					certain date and time Easymanga we may have backed up data
					for our own purposes. We make no guarantee that the data you
